...
void real::DepthBuffer::Create(const GameContext& context)
{
...
VkFormat real::DepthBuffer::FindDepthFormat(const GameContext& context)
{
...
bool real::DepthBuffer::HasStencilComponent(const VkFormat format)
{
