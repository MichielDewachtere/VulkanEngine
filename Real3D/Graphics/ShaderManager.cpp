...
void real::ShaderManager::Init(std::string shaderSourcePath)
{
	m_ShaderDataPath = std::move(shaderSourcePath);
}

VkPipelineShaderStageCreateInfo real::ShaderManager::CreateShaderInfo(const VkDevice& device, const ShaderType type,
...
void real::ShaderManager::DestroyShaderModules(VkDevice device)
{
...
VkShaderModule real::ShaderManager::CreateShaderModule(const VkDevice& device, const std::vector<char>& code)
{
