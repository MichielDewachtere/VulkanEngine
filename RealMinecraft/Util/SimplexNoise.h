...
public:
    ...
    float fractal(size_t octaves, double x) const;
    float fractal(size_t octaves, double x, double y) const;
    float fractal(size_t octaves, double x, double y, double z) const;
