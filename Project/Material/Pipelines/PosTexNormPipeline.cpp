...
void PosTexNormPipeline::CleanUp(VkDevice device)
{
	Pipeline::CleanUp(device);
}

void PosTexNormPipeline::CreatePipeline(const VulkanContext& vulkan)
{
...
void PosTexNormPipeline::CreateDescriptorSetLayout(const VkDevice& device)
{
