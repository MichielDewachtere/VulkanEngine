...
Texture2D* ContentManager::LoadTexture(const GameContext& context, const std::string& path)
{
...
Model* ContentManager::LoadModel(const std::string& path, const glm::vec3& pos)
{
...
void ContentManager::CleanUp(const GameContext& context)
{
