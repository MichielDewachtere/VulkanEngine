...
void InputManager::Initialize(const GameContext& context)
{
	//m_Context = context;
...
void InputManager::UpdateInputStates(const GameContext& context, bool /*override*/)
{
...
const glm::ivec2& InputManager::GetMouseMovement() const
{
	return m_MouseMovement;
}

bool InputManager::IsKeyboardKey(InputState state, int key) const
{
...
bool InputManager::IsMouseButton(InputState state, MouseButton button) const
{
	switch (state)
	{
	case InputState::down:
...
void InputManager::UpdateKeyboardStates() const
{
...
void InputManager::UpdateMouseStates(const GameContext& context)
{
...
bool InputManager::IsMouseButtonDown(MouseButton button, bool previousFrame) const
{
	if (previousFrame)
...
bool InputManager::IsKeyCodeValid(int code)
{
